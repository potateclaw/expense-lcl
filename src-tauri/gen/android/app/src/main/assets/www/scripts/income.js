...
async function fetchIncomeData() {
    try {
        ...
        try {
            incomeData.sources = await window.__invoke__('get_income_sources') || [];
        } catch (e) {
        ...
        try {
            const subscriptions = await window.__invoke__('get_subscriptions') || [];
        ...
        try {
            const goals = await window.__invoke__('get_savings_goals') || [];
...
async function submitIncomeSource() {
    ...
    try {
        await window.__invoke__('add_income_source', {
            name,
            amount,
            frequency,
