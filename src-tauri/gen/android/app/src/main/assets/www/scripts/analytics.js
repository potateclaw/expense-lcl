...
async function fetchAnalyticsData() {
    ...
    try {
        // Fetch categories
        try {
            analyticsData.categories = await window.__invoke__('get_categories');
        } catch (e) {
        ...
        try {
            const transactions = await window.__invoke__('get_transactions', { limit: 1000 });
        ...
        try {
            analyticsData.summary = await window.__invoke__('get_dashboard_summary');
        } catch (e) {
